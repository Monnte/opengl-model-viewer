...
void main()
{
    ...
    lightPositions[0] =  data_in[0].lightPositions[0];
    lightPositions[1] =  data_in[0].lightPositions[1];
    lightPositions[2] =  data_in[0].lightPositions[2];
    lightPositions[3] =  data_in[0].lightPositions[3];
    ...
    lightPositions[0] =  data_in[1].lightPositions[0];
    lightPositions[1] =  data_in[1].lightPositions[1];
    lightPositions[2] = data_in[1].lightPositions[2];
    lightPositions[3] =  data_in[1].lightPositions[3];
    ...
    lightPositions[0] =  data_in[2].lightPositions[0];
    lightPositions[1] =  data_in[2].lightPositions[1];
    lightPositions[2] =  data_in[2].lightPositions[2];
    lightPositions[3] =  data_in[2].lightPositions[3];
